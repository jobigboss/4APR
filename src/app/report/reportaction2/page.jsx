...
function ReportPage() {
  ...
  // คำนวณจำนวนผู้ที่เข้าร่วมกิจกรรม 2 แล้วและยังไม่เข้าร่วมกิจกรรม
  const participatedCount = checkedInData.filter((item) => item.activity2 === true).length;
  const notParticipatedCount = checkedInData.filter((item) => item.activity2 === false).length;

  console.log("เข้าร่วมกิจกรรม 2 แล้ว:", participatedCount);
  console.log("ยังไม่เข้าร่วมกิจกรรม 2:", notParticipatedCount);
  ...
  return (
    <div className="p-6 flex items-center justify-center">
      <div>
        <PieChartSection title="รายงานกิจกรรมที่ 2" data={pieData} />
      </div>
    </div>
  );
}
